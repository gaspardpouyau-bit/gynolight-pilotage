  ...
  return (
    <div className="flex-1 flex flex-col h-full bg-white overflow-y-auto">
      ...
      <div className="px-6 space-y-8">
        ...
        <section>
          ...
          <div className="bg-pink-50 p-5 rounded-2xl flex items-center justify-between border border-pink-100">
            ...
            <button
              ...
              className={`px-4 py-2 rounded-lg text-xs font-bold transition-all ${isConnected ? 'bg-white text-red-500 hover:bg-red-50' : 'bg-pink-500 text-white hover:bg-pink-600'
                }`}
            >
        ...
        <section className="space-y-3">
          ...
          <div className="w-full flex items-center justify-between p-4 bg-gray-50 rounded-xl">
            ...
            <button
              ...
              className={`w-10 h-6 rounded-full relative transition-colors ${notifications ? 'bg-pink-500' : 'bg-gray-300'}`}
            >
        ...
        {/* Logout */}
        <button className="w-full flex items-center justify-center gap-2 p-4 text-red-500 font-bold border-2 border-red-50 rounded-xl hover:bg-red-50 transition-colors mt-8">
